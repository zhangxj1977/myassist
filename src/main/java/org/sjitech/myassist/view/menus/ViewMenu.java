...
/**
 * A menu that contains a {@link JCheckBoxMenuItem} for every {@link Dockable}
 * known to the {@link DockFrontend}. The user can show and hide
 * <code>Dockable</code>s by clicking on these items.
 * 
 */
...
public class ViewMenu extends JMenu {
	...
	/**
	 * Creates a new menu that observes <code>frontend</code>. The items of the
	 * menu are read once from <code>frontend</code>, and will not change when
	 * new <code>Dockable</code>s are registered to <code>frontend</code>.
	 * 
	 * @param frontend
	 *            the list of <code>Dockable</code>s
	 */
	public ViewMenu(DockFrontend frontend) {
	 ...
	 */
	private class Item extends JCheckBoxMenuItem implements ActionListener,
			DockFrontendListener {
		/** whether the state currently is changing or not */
		private boolean onChange = false;

		/**
		 * the <code>Dockable</code> whose visibility-state is represented by
		 * this item
		 */
		 ...
		 * 
		 * @param dockable
		 *            the element whose visibility-state is represented by this
		 *            item.
		 */
		...
		public void hideable(DockFrontend frontend, Dockable dockable,
				boolean hideable) {
			// ignore
		}
